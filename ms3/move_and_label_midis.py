...
#this function moves files beginning in specified beginningfrom fromDir to toDir.
#NOT USED FOR MIDI CLASSIFICATION
...
midi_ending = '.mid'
#this line moves files ending in .mid form the Downloads folder to a folder made for edm music that can be changed
